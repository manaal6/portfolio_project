...
<style>
  ...
  .item { position:relative; padding:1.5rem 0 2rem; }
  .dot { position:absolute; left:-2.4rem; top:1.9rem; width:10px; height:10px; border-radius:50%; background:#f39c12; box-shadow:0 0 12px rgba(243,156,18,0.5); border:2px solid #080808; }
  .role { font-family:'Syne',sans-serif; font-size:1rem; font-weight:700; color:#f0f0f0; margin-bottom:.2rem; }
